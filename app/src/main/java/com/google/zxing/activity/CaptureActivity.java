...
import com.spawpaw.android.tools.PermissionUtils;
 ...
 * @author Ryan.Tang
 */
public class CaptureActivity extends BaseAppCompatActivity implements Callback, PermissionUtils.RequestCallback {

    private static final int REQUEST_CODE_SCAN_GALLERY = 100;
    public static final int REQUEST_CODE_OCR = 10086;
...
//        if (requestCode == RESULT_OK) {
        switch (requestCode) {
            case REQUEST_CODE_OCR:
                Toast.makeText(CaptureActivity.this, "xxxxxxxxxxxxxxxx", Toast.LENGTH_SHORT).show();

                break;
            case REQUEST_CODE_SCAN_GALLERY:
                Toast.makeText(CaptureActivity.this, "ssssss", Toast.LENGTH_SHORT).show();
                //获取选中图片的路径
